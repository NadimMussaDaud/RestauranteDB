...
CREATE TABLE FREQUENTAM (
    ...
    FOREIGN KEY (CC) REFERENCES PESSOAS(CC) ON DELETE CASCADE,
    FOREIGN KEY (NUMEROCADEIA) REFERENCES RESTAURANTES(NUMEROCADEIA, CP) ON DELETE CASCADE
);
...
CREATE TABLE FORNECE (
    ...
    FOREIGN KEY (CC) REFERENCES PESSOAS(CC) ON DELETE CASCADE,
    FOREIGN KEY (CODIGOINGREDIENTE) REFERENCES INGREDIENTES(CODIGOINGREDIENTES) ON DELETE CASCADE
);
...
BEGIN
    ...
    UPDATE GERE
    SET DIRECAO_CC = :NEW.CC
    WHERE DIRECAO_CC = :OLD.CC;
...
BEGIN
    UPDATE STOCK
    SET CODIGOINGREDIENTE = :NEW.CODIGOINGREDIENTE
    WHERE CODIGOINGREDIENTE = :OLD.CODIGOINGREDIENTE;
